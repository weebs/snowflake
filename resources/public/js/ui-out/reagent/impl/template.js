...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__17485__auto__,writer__17486__auto__,opt__17487__auto__){
return cljs.core._write.call(null,writer__17486__auto__,"reagent.impl.template/NativeWrapper");
});
...
var or__16887__auto__ = reagent.impl.template.named_QMARK_.call(null,x);
...
var or__16887__auto__ = reagent.impl.template.hiccup_tag_QMARK_.call(null,x);
if(cljs.core.truth_(or__16887__auto__)){
return or__16887__auto__;
} else {
...
var G__148050 = o;
(G__148050[reagent.impl.template.cached_prop_name.call(null,k)] = reagent$impl$template$convert_prop_value.call(null,v));
...
return (function() { 
var G__148051__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
var G__148051 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__148052__i = 0, G__148052__a = new Array(arguments.length -  0);
while (G__148052__i < G__148052__a.length) {G__148052__a[G__148052__i] = arguments[G__148052__i + 0]; ++G__148052__i;}
  args = new cljs.core.IndexedSeq(G__148052__a,0);
} 
return G__148051__delegate.call(this,args);};
G__148051.cljs$lang$maxFixedArity = 0;
G__148051.cljs$lang$applyTo = (function (arglist__148053){
var args = cljs.core.seq(arglist__148053);
return G__148051__delegate(args);
});
G__148051.cljs$core$IFn$_invoke$arity$variadic = G__148051__delegate;
return G__148051;
})()
;
} else {
...
var old_148054 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_.call(null,old_148054))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_148054)].join(''):class$));
} else {
}
...
if(cljs.core.not.call(null,(function (){var and__16875__auto__ = (node === document.activeElement);
if(and__16875__auto__){
var and__16875__auto____$1 = reagent.impl.template.has_selection_api_QMARK_.call(null,(node["type"]));
...
if(cljs.core.truth_((function (){var and__16875__auto__ = (jsprops["hasOwnProperty"])("onChange");
...
var G__148057 = jsprops;
(G__148057["defaultValue"] = value);

(G__148057["onChange"] = ((function (G__148057,v,value,on_change){
return (function (p1__148055_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__148055_SHARP_);
});})(G__148057,v,value,on_change))
);
...
var vec__148059 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__148059,(0),null);
var id = cljs.core.nth.call(null,vec__148059,(1),null);
var class$ = cljs.core.nth.call(null,vec__148059,(2),null);
...
var temp__4427__auto__ = (function (){var G__148063 = cljs.core.meta.call(null,v);
var G__148063__$1 = (((G__148063 == null))?null:reagent.impl.template.get_key.call(null,G__148063));
return G__148063__$1;
})();
if((temp__4427__auto__ == null)){
...
var jsprops = {"argv": v};
var G__148065_148066 = v;
var G__148065_148067__$1 = (((G__148065_148066 == null))?null:reagent.impl.template.key_from_vec.call(null,G__148065_148066));
var G__148065_148068__$2 = (((G__148065_148067__$1 == null))?null:(jsprops["key"] = G__148065_148067__$1));
...
var p = (function (){var temp__4427__auto__ = (function (){var G__148071 = cljs.core.meta.call(null,argv);
var G__148071__$1 = (((G__148071 == null))?null:reagent.impl.template.get_key.call(null,G__148071));
return G__148071__$1;
})();
if((temp__4427__auto__ == null)){
return jsprops;
} else {
var key = temp__4427__auto__;
var G__148072 = (((jsprops == null))?{}:jsprops);
(G__148072["key"] = key);
...
var G__148073 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__148073;
continue;
}
} else {
...
var n__17790__auto___148074 = a.length;
var i_148075 = (0);
while(true){
if((i_148075 < n__17790__auto___148074)){
(a[i_148075] = reagent.impl.template.as_element.call(null,(a[i_148075])));

var G__148076 = (i_148075 + (1));
i_148075 = G__148076;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__17790__auto___148077 = a.length;
var i_148078 = (0);
while(true){
if((i_148078 < n__17790__auto___148077)){
var val_148079 = (a[i_148078]);
if((cljs.core.vector_QMARK_.call(null,val_148079)) && ((reagent.impl.template.key_from_vec.call(null,val_148079) == null))){
(o["no-key"] = true);
} else {
}

(a[i_148078] = reagent.impl.template.as_element.call(null,val_148079));

var G__148080 = (i_148078 + (1));
i_148078 = G__148080;
continue;
} else {
}
...
if(cljs.core.truth_((function (){var and__16875__auto__ = cljs.core.not.call(null,reagent.impl.component._STAR_non_reactive_STAR_);
if(and__16875__auto__){
return (ctx["no-key"]);
} else {
return and__16875__auto__;
...
var G__148082 = (cljs.core.count.call(null,argv) - first_child);
switch (G__148082) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__148082){
